<?php
/**
 * Plugin Name: LaraPress Autoloader
 * Plugin URI: https://gitlab.com/larapress/larapress/
 * Description: An autoloader that enables standard plugins to be required just like must-use plugins. The autoloaded plugins are included during mu-plugin loading. An asterisk (*) next to the name of the plugin designates the plugins that have been autoloaded.
 * Version: 1.0.0
 * Author: LaraPress
 * Author URI: https://larapress.io/
 * License: MIT License
 */

namespace xPress\LaraPress;
...
/**
 * Class Autoloader
 * @package xPress\LaraPress
 * @author LaraPress
 * @link https://larapress.io/
 */
class Autoloader
{
    ...
    */
    ...
    {
        $cache = get_site_option('larapress_autoloader');
    ...
    private function updateCache()
    {
        ...
        update_site_option('larapress_autoloader', self::$cache);
    }
